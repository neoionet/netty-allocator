...
final class MiUnpooledHeapByteBuf extends UnpooledHeapByteBuf implements MiByteBufAdapter {

    MiUnpooledHeapByteBuf(ByteBufAllocator alloc, int initialCapacity, int maxCapacity) {
